...
image:https://github.com/Arc-E-Tect/SoftwareEngineeringDoneRight-Gradle/actions/workflows/jacoco-exclusion-report-security-scan.yml/badge.svg[Security Scan,link=https://github.com/Arc-E-Tect/SoftwareEngineeringDoneRight-Gradle/actions/workflows/jacoco-exclusion-report-security-scan.yml]
...
After the task runs, four files can be written to the configured `reportDir`
