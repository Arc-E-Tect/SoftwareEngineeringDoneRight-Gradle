...
public class UserController {
    ...
    public String getUserByUsername(@PathVariable String username) {
        // Verified by a real Spring RestDocs test that resolves its request path via a static
        // ApiEndpoints.get(key) helper method, not a string literal - see src/test/java.
        return "{}";
    }
