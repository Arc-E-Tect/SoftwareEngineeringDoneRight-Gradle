 ...
 *
 * <p>Correct location: {@code com.example.hexapp.port.in.CreateOrderUseCase}</p>
 * <p>Actual location:  {@code com.example.hexapp.application.CreateOrderUseCase} ← VIOLATION</p>
 */
