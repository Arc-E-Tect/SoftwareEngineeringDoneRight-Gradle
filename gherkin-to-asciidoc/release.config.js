...
module.exports = {
    ...
    // A "gherkin-to-asciidoc-v5.1.0" tag is seeded at the commit that was already the plugin's
    // last published version under the shared tag pool, so the next release continues from
