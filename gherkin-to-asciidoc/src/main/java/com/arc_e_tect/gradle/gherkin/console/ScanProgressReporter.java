...
public final class ScanProgressReporter {
     ...
     * @param phaseLabel short label identifying the scan phase, e.g. {@code "Parsing feature files"}
     ...
     * include a running fraction and percentage, e.g. {@code "Parsing feature files: 150/438 (34%)"}.
     *
     * @param logger     the logger status lines are emitted to, at {@code LIFECYCLE} level
     * @param phaseLabel short label identifying the scan phase
     ...
     * lines report only a running count, e.g. {@code "Scanning glue code: 27 processed so far"}.
     *
     * @param logger     the logger status lines are emitted to, at {@code LIFECYCLE} level
     * @param phaseLabel short label identifying the scan phase
