...
public class ArchitectureValidatorPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        var generateTask = project.getTasks().register(
                ...
                task -> {
                    ...
                    task.getConfigurationPackages().set(extension.getHexagonalArchitecture().getConfigurationPackages());
                    task.getPortDataTypePackages().set(extension.getHexagonalArchitecture().getPortDataTypePackages());
    ...
    private void configureArchitectureTestTask(
        ...
        testTask.systemProperty("architectureValidator.domainServices", String.join(",", extension.getHexagonalArchitecture().getDomainServices().get()));
        testTask.systemProperty("architectureValidator.configurationPackages", String.join(",", extension.getHexagonalArchitecture().getConfigurationPackages().get()));
        testTask.systemProperty("architectureValidator.portDataTypePackages", String.join(",", extension.getHexagonalArchitecture().getPortDataTypePackages().get()));
